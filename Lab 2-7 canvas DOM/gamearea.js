function GameArea(){
    ...
    this.tileMenuDivL.setAttribute("style", " background-color:#FFFFFF; width:100px; height:696px;float:left;");
    // create tileMenuDiv
    ...
    this.tileMenuDivR.setAttribute("style", " background-color:#FFFFFF; width:100px; height:696px;float:right;");
